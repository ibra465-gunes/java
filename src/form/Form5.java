...
public class Form5 extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        list=serviceProject.readSearchFile(project, "Yazılım","0");
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/software1.png"))); // NOI18N
        jLabel1.setText("Yazılım Projesi Görev Tablosu");
