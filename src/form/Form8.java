...
public class Form8 extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        list=serviceProject.readSearchFile(project, "Ekip Gezisi","0");
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/excursion1.png"))); // NOI18N
        jLabel1.setText("Ekip Gezisi Görev Tablosu");
